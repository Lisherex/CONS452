...
cor.test(Brackish$Average_Salinity, Brackish$veg_year)
...
cor.test(Fresh$Average_Salinity, Fresh$veg_year)
...
cor.test(Intermediate$Average_Salinity, Intermediate$veg_year)
...
cor.test(Saline$Average_Salinity, Saline$veg_year)
...
cor.test(AveVVI_vs_AveSal$Average_Salinity, AveVVI_vs_AveSal$veg_year)
